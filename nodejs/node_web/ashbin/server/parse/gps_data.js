...
module.exports.add_data_dili = function(data) {
    ...
    var _lat = parseInt(data.slice(106, 114), 16);
    _lat = (parseFloat(_lat) / 1000000).toFixed(6);
    item.lat = _lat 
    var _lng = parseInt(data.slice(114, 122), 16);
    _lng = (parseFloat(_lng) / 1000000).toFixed(6);
    item.lng = _lng
 ...
 * 部标协议：
 * 7E090000420120000004910000FA2A444654445F4C4A540201800158003500003600028514000035000036002000000000000C00000159C18F06CC9FF3005B000000C5170622194144010400000064007E
 * 7E090000XX0120000004910000FA2a444d464c5f4c4a5400018001582000000000000C00000159C18F06CC9FF3005B000000C5170622194144010400000064XX7E
 * @param {any} data 
 * @returns 
 */
module.exports.add_data_dimai = function(data) {
