...
function get_record(id){
	...
	$.ajax({
		...
		success : function(json) {
			//显示记录
			$("#txtID").val(json.ID)
			$("#txtMemberNo").val(json.MemberNo)
			$("#txtAccount").val(json.Account)
			$("#txtTrueName").val(json.TrueName)
			$("#txtIDCard").val(json.IDCard)
			$("#txtWeXinID").val(json.WeXinID)
			$("#txtMobile").val(json.Mobile)
			$("#txtParentID").val(json.ParentID)
			$("#txtJoinTime").val(json.JoinTime)
