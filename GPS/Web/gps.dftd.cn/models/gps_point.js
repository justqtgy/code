...
gps_point.get_count = function(params, callback) {
    var sql = " select count(*) as total from gserver_packet.dbo.gps_point where addtime >='%s' and addtime<dateadd(day, 1, '%s')";
...
gps_point.get_list = function(params, callback) {
    ...
    var sql = "select top 10 *, datediff(minute, AddTime1, AddTime2) as TimeUsed, convert(varchar(10), AddTime1, 120) as CreateDate " +
        "   from gserver_packet.dbo.gps_point  " +
